...
scene_name = "781b04c8-43b4-431e-af55-1ae2b2efc873"
...
egoState.transform = sim.map_point_on_lane(lgsvl.Vector(-0.044, 0.849, 270-195))
# For SanFrancisco
...
ego = sim.add_agent(name = "3bb4c2eb-82d3-4ee3-8ebb-2bdbcf6e88ea", agent_type = lgsvl.AgentType.EGO, state = egoState)
...
npcState.transform.position = egoState.position + 70 * forward - 3.6 * right # NPC is 3.6m to the left of the EGO
#npc = sim.add_agent("Jeep", lgsvl.AgentType.NPC, npcState)
npc = sim.add_agent(name = "3bb4c2eb-82d3-4ee3-8ebb-2bdbcf6e88ea", agent_type = lgsvl.AgentType.NPC, state = npcState)
