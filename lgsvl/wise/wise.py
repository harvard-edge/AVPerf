...
class DefaultAssets:
    ...
    # Map loaded in the quickstart scripts. Changing the map may lead to unexpected behaviour in the quickstart scripts. Default value is "AshCity".
    # https://wise.svlsimulator.com/maps/profile/fa5c9fde-acd5-44a0-b0f6-a237daa47f45
    map_ashcity = "fa5c9fde-acd5-44a0-b0f6-a237daa47f45"

    # Map loaded in the quickstart scripts. Changing the map may lead to unexpected behaviour in the quickstart scripts. Default value is "BorregasAve".
    # https://wise.svlsimulator.com/maps/profile/45dd30b0-4be1-4eb7-820a-3e175b0117fc
    map_moderncity = "45dd30b0-4be1-4eb7-820a-3e175b0117fc"
    ...
    # This has sensors for modular testing.
    # https://wise.svlsimulator.com/vehicles/profile/73805704-1e46-4eb6-b5f9-ec2244d5951e/edit/configuration/2e9095fa-c9b9-4f3f-8d7d-65fa2bb03921
    ego_lincoln2017mkz_apollo6_full_analysis = "64cc50fa-b8d4-4569-87fa-d1612909d6d0"

    # Ego vehicle that is loaded in most of the Apollo 6.0 scripts. Default value is "Lincoln2017MKZ" using the "Apollo 6.0 (modular testing)" sensor configuration.
    # This has sensors for modular testing.
    ego_lincoln2017mkz_apollo5_full_analysis_test = "e3497667-b04f-4569-ba70-09354e5bd003"
